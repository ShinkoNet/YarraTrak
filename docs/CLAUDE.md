...
This file provides guidance to OpenRouter Code when working with this repository.
...
### Run the MCP Server (for OpenRouter Desktop integration)
```bash
...
| `server/mcp_server.py` | MCP protocol wrapper for OpenRouter Desktop |
