...
// aplite and sdk 2.9 compatibility utilities these are a collection of types and compatibility macros taken from sdk 3.0
...
// legacy definitions for basalt on 3.0 these should eventually be removed in the future
#ifdef PBL_SDK_3
