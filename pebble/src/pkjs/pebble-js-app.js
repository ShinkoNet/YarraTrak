...
// resubscribe after settings changes
...
function handleFavUpdate(msg) {
    ...
    for (var i = 0; i < updates.length; i++) {
        ...
        // keep one spare departure for auto-advance
