...
# populated from: websocket connect (learns buttons), llm set_button (dynamic update) background broadcast loop keeps all
...
async def voice_query(
    ...
    # add vibration pattern for results and trim to first departure only extract learned_stop if this was a successful query
    learned_stop = None
